    ...
    return (
      <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
        ...
        <AlertDialogContent className='bg-gray-900 border-0'>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel disabled={isDeletingState} className='bg-gray-900 hover:bg-gray-700 hover:text-white border-0'>
              {cancelButtonText}
            </AlertDialogCancel>
            <AlertDialogAction
  ...
  return (
    <>
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto className='bg-gray-900 border-0'">
          <DialogHeader>
